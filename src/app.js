...
function render(){
  ...
  if(game.phase==='initial-reveal') els.instruction.textContent=isHumanTurn()?`Wähle deine ersten zwei Karten – noch ${initialLeft}.`:`${current.name} deckt zwei Startkarten auf …`;
