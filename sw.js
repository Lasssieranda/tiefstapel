const CACHE = 'tiefstapel-v7';
const SHELL = ['./','index.html','styles.css?v=301','src/app.js?v=301','src/engine.js?v=301','manifest.webmanifest?v=301','icons/icon-192.png?v=301','icons/icon-512.png?v=301'];
