const CACHE = 'tiefstapel-v16';
const SHELL = ['./','index.html','styles.css?v=310','src/app.js?v=310','src/engine.js?v=310','manifest.webmanifest?v=310','icons/icon-192.png?v=310','icons/icon-512.png?v=310'];
