const CACHE = 'tiefstapel-v19';
const SHELL = ['./','index.html','styles.css?v=313','online.css?v=313','src/online.bundle.js?v=313','src/app.js?v=313','src/engine.js?v=313','manifest.webmanifest?v=313','icons/icon-192.png?v=313','icons/icon-512.png?v=313'];
