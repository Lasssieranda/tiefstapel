const CACHE = 'tiefstapel-v6';
const SHELL = ['./','index.html','styles.css?v=300','src/app.js?v=300','src/engine.js?v=300','manifest.webmanifest?v=300','icons/icon-192.png?v=300','icons/icon-512.png?v=300'];
