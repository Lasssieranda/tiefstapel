const CACHE = 'tiefstapel-v5';
const SHELL = ['./','index.html','styles.css','src/app.js?v=201','src/engine.js?v=201','manifest.webmanifest','icons/icon-192.png','icons/icon-512.png'];
