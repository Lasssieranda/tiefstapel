const CACHE = 'tiefstapel-v9';
const SHELL = ['./','index.html','styles.css?v=303','src/app.js?v=303','src/engine.js?v=303','manifest.webmanifest?v=303','icons/icon-192.png?v=303','icons/icon-512.png?v=303'];
